...
function UserFormValidator() {
    ...
    function init(config) {
        ...
        // Clear roles once create form is displayed
        if (!Boolean(ui.$fieldUserId.val())) { // If creation mode
            ui.$fieldRoles.val(null).trigger('change');
        }
    }
