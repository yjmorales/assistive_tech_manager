...
class ATDeviceController extends BaseController
{
    ...
    public function create(Request $request, ManagerRegistry $doctrine): Response
    {
        ...
        if (!$saved) {
            return $this->render('/admin/authenticated/at_device/create.html.twig', [
                'entity'     => $entity,
    ...
    {
        $form     = $this->createForm(ATDeviceFormType::class, $entity);
        $response = $this->redirectToRoute('admin_at_device_list');

        if (!$this->_save($request, $doctrine, $form, $entity)) {
            return $this->render('/admin/authenticated/at_device/edit.html.twig', [
                'form'       => $form->createView(),
                'entity'     => $entity,
                'breadcrumb' => [
                    'Dashboard'      => $this->generateUrl('admin_dashboard'),
